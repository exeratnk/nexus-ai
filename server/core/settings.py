...
FREE_DAILY_MESSAGE_LIMIT = int(os.environ.get('FREE_DAILY_MESSAGE_LIMIT', '12'))
SUBSCRIPTION_WEBHOOK_TOKEN = os.environ.get('SUBSCRIPTION_WEBHOOK_TOKEN', 'nexus-demo-webhook')
